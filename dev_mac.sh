...
cd "vendor/gta-toolkit"
	...
	dotnet publish "RageLib.GTA5/RageLib.GTA5.csproj" -c Release -r osx-x64 --self-contained true --nologo
	cp "RageLib.GTA5/bin/Release/net5.0/osx-x64/RageLib.dll" "bin/"
	cp "RageLib.GTA5/bin/Release/net5.0/osx-x64/RageLib.GTA5.dll" "bin/"
cd ../..